...
===========================================================================================
Script Purpose: 
This stored procedure loads data into the 'bronze' schema from csv files by
* Truncating the bronze tables before loading data
* Uses the 'BULK INSERT' to load the data from it's filepath to the bronze tables
Example:
